...
{  
  ...
  while (1)                                                                             //driving loop with triggers at 1, 10 and 100
  {
    ...
    if (TIMER_ELAPSED(timer_10ms))
    {
      ...
      apd_power_voltage_controlling();  //Adjust Voltage and encoder processes periodiclally
...
//Only "main.c" part
void load_nvram_values(void)                                                       // set values 
{
