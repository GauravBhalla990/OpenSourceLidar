...
{
  apd_power_timer_init(); // timer initializer
  apd_power_timer_activate_pwm(); //activating pwm
  
  apd_power_adc_init();
  apd_power_init_dma(); // direct memory access
...
//ADC1 & ADC2 (analog-digital converters)
void apd_power_adc_init(void)
{
...
// DMA is used to capture data from ADC (anaolog-digital converter)
void apd_power_init_dma(void)
{
